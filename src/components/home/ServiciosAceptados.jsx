...
// `apoyo_direccion` (que solo se lee tras el acuerdo) y para MUVET Turnos de
// `relevo_ficha_contacto` (que revela la sede de la clínica tras el acuerdo).
// Si no llega, se dice que se coordina por el chat en vez de mentir con un
// vacío.
      ...
      {items.map((item) => (
        <Card key={item.id}>
          ...
          >
            ...
            <p className="text-[12px] font-medium text-[#1A7A5E]">Abrir servicio y chat →</p>
          </button>
        </Card>
      ))}
    </div>
